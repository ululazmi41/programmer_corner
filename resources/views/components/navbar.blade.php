<div class="w-full border-b-gray-400">
    <div class="flex pr-3 justify-between sm:px-12 py-2 items-center">
        <div class="flex items-center">
            <div class="pl-3 mr-3 relative sm:hidden inline-block text-left">
                ...
                <div id="menuDropdownMenu"
                    class="block absolute left-0 z-10 mt-2 w-screen h-screen origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none"
        ...
        <form action="/search" method="POST" class="w-2/5">
            @csrf
            <input
                class="hidden sm:block w-full text-gray-700 shadow appearance-none border rounded py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
        ...
        @guest
            <div class="flex gap-4">
                <a href="/login">
                    <button
                        class="w-full bg-blue-500 hover:opacity-70 text-white py-1 px-4 rounded-lg focus:outline-none focus:shadow-outline transform transition duration-150">
                        Login
                    </button>
                </a>
                <div class="relative inline-block text-left">
                    ...
                    <label for="guestDropdownToggle">
                        <x-heroicon-o-ellipsis-horizontal class="w-8 cursor-pointer" />
                    </label>
                    ...
                    <div id="guestDropdownMenu"
                        ...
                        role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                        <div class="py-2 px-1 grid gap-1" role="none">
                            <a href="/register" class="flex gap-2 items-center px-4 py-2 text-md text-gray-700"
                                role="menuitem" tabindex="-1" id="menu-item-0">
                                <Image class="w-4 h-4 inline" src="/img/register.png" alt="register icon" />
                                Register
                            </a>
                            <a href="/login" class="flex gap-2 items-center px-4 py-2 text-md text-gray-700"
                                role="menuitem" tabindex="-1" id="menu-item-1">
